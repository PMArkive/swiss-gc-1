...
GuiKeyboard::GuiKeyboard(char * t, u32 max)
{
	...
	keyTextbox = new GuiImageData(keyboard_textbox_tpl, 400, 40, keyboard_textbox_tpl_size);
	...
	key = new GuiImageData(keyboard_key_tpl, 40, 40, keyboard_key_tpl_size);
	keyOver = new GuiImageData(keyboard_key_over_tpl, 40, 40, keyboard_key_over_tpl_size);
	keyMedium = new GuiImageData(keyboard_mediumkey_tpl, 80, 40, keyboard_mediumkey_tpl_size);
	keyMediumOver = new GuiImageData(keyboard_mediumkey_over_tpl, 80, 40, keyboard_mediumkey_over_tpl_size);
	keyLarge = new GuiImageData(keyboard_largekey_tpl, 200, 40, keyboard_largekey_tpl_size);
	keyLargeOver = new GuiImageData(keyboard_largekey_over_tpl, 200, 40, keyboard_largekey_over_tpl_size);
