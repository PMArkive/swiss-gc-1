...
GuiFileBrowser::GuiFileBrowser(int w, int h)
{
	...
	bgFileSelection = new GuiImageData(bg_file_selection_tpl, 540, 248, bg_file_selection_tpl_size);
	...
	bgFileSelectionEntry = new GuiImageData(bg_file_selection_entry_tpl, 540, 32, bg_file_selection_entry_tpl_size);
	fileFolder = new GuiImageData(folder_tpl, 32, 32);

	scrollbar = new GuiImageData(scrollbar_tpl, 40, 192, scrollbar_tpl_size);
	scrollbarImg = new GuiImage(scrollbar);
	scrollbarImg->SetParent(this);
	scrollbarImg->SetAlignment(ALIGN_RIGHT, ALIGN_TOP);
	scrollbarImg->SetPosition(0, 30);

	arrowDown = new GuiImageData(scrollbar_arrowdown_tpl, 40, 40, scrollbar_arrowdown_tpl_size);
	arrowDownImg = new GuiImage(arrowDown);
	arrowDownOver = new GuiImageData(scrollbar_arrowdown_over_tpl, 40, 40, scrollbar_arrowdown_over_tpl_size);
	arrowDownOverImg = new GuiImage(arrowDownOver);
	arrowUp = new GuiImageData(scrollbar_arrowup_tpl, 40, 40, scrollbar_arrowup_tpl_size);
	arrowUpImg = new GuiImage(arrowUp);
	arrowUpOver = new GuiImageData(scrollbar_arrowup_over_tpl, 40, 40, scrollbar_arrowup_over_tpl_size);
	arrowUpOverImg = new GuiImage(arrowUpOver);
	scrollbarBox = new GuiImageData(scrollbar_box_tpl, 40, 44, scrollbar_box_tpl_size);
	scrollbarBoxImg = new GuiImage(scrollbarBox);
	scrollbarBoxOver = new GuiImageData(scrollbar_box_over_tpl, 40, 44, scrollbar_box_over_tpl_size);
